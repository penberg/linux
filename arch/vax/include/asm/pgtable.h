#ifndef _ASM_VAX_PGTABLE_H
#define _ASM_VAX_PGTABLE_H

/*
 * FIXME: This is copy from arch/score. It needs to be adapted for VAX.
 */
...
#define PAGE_KERNEL_UNCACHED __pgprot(_PAGE_VALID)
...
{
	return pte_val(pte) & _PAGE_MODIFY;
}
